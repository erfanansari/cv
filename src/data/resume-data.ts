...
export const RESUME_DATA = {
  ...
  work: [
    {
      ...
      description: [
        ...
        "Achieved 90+ Lighthouse scores across multiple applications via lazy loading, code splitting, and strategic caching — boosting performance and SEO metrics by 30-50%.",
        "Built comprehensive test automation suite with Jest, Cypress, and Playwright, achieving 85%+ coverage while cutting manual QA workload by 75%.",
        "Created an automated TypeScript SDK generator with a custom AST parser, React Query integration, and Zod schemas for runtime type validation.",
        "Established multi-stage Docker builds and CI/CD workflows across 15+ projects, standardizing deployment processes and quality gates.",
        "Consolidated six separate repositories into a unified monorepo with type-safe configuration management and a theme system for a multi-brand CRM platform.",
      ],
      // description: [
      //   "Spearheaded migration of 5 projects from Next.js Pages Router to App Router, enabling advanced SSR patterns and improved caching architecture.",
    ...
    },
    {
      ...
      description: [
        "Developed Web3 integration features — MetaMask wallet connectivity and blockchain tokenization for dApp components.",
        "Automated type-safe API integration by generating TypeScript definitions from OpenAPI docs, eliminating frontend breaking-change defects.",
        "Integrated PayPal payment gateway, expanding payment options.",
        "Cut Largest Contentful Paint 45% via lazy-loading strategies.",
  ...
  projects: [
    ...
    },
    {
      ...
      techStack: ["TypeScript", "React", "Next.js"],
      description:
        "Fundamentals of signal processing with interactive visualizations",
